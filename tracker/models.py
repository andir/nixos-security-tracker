...
class ChannelRevision(models.Model):
    ...
    channel = models.ForeignKey(
        Channel, on_delete=models.CASCADE, related_name="revisions"
    )
...
class PackageAttributeName(models.Model):
    ...
    class Meta:
        indexes = (HashIndex(fields=("value",)),)
...
class Package(models.Model):
    ...
    name_row = models.ForeignKey(
        PackageName, on_delete=models.CASCADE, related_name="packages"
    )
    version_row = models.ForeignKey(
        PackageVersion, on_delete=models.CASCADE, related_name="packages"
    )
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=("channel_revision", "attribute_name_row")),
        ]
